...
_target = _this select 0; // player

_data=[
assignedItems _target,

[primaryWeapon _target, primaryWeaponItems _target],

[handgunWeapon _target, handgunItems _target],

[secondaryWeapon _target, secondaryWeaponItems _target],
